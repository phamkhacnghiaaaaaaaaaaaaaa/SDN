        ...
        <div className="min-h-screen flex flex-col">
            ...
            <header className="main-header">
                <div className="main-header__inner">
                    {/* Logo - Giữ lại hoặc trỏ về trang dashboard của staff */}
                    <Link to="/staff/books" className="main-logo">
                ...
                <div className="main-footer__inner">
                    <div className="main-footer__grid">
                        ...
                        <div className="main-footer__brand">
                            ...
                            <p className="main-footer__brand-desc">
                                Staff Portal - Quản lý hệ thống thư viện kỹ thuật số.
                            </p>
                        </div>

                        {/* Quick Links - Đã bỏ Home */}
                        <div>
                            <h4 className="main-footer__section-title">Quick Links</h4>
                            <ul className="main-footer__links">
                                <li>
                                    <Link to="/staff/books">Manage Books</Link>
                                </li>
                                <li>
                                    <Link to="/staff/categories">Categories</Link>
                                </li>
                                <li>
                                    <Link to="/staff/authors">Authors</Link>
                                </li>
                            </ul>
                        </div>
                        ...
                        {/* Contact */}
                        <div>
                            <h4 className="main-footer__section-title">Contact Support</h4>
                            <div className="main-footer__contact-item">
                                <Mail size={15} />
                                <span>it.support@sdn302.edu.vn</span>
                            </div>
                            <div className="main-footer__contact-item">
                                <Phone size={15} />
                    ...
                    <div className="main-footer__bottom">
                        <p className="main-footer__copyright">
                            © 2026 Library SDN302 Staff Portal. All rights reserved.
                        </p>
                    </div>
                </div>
            </footer>
